        ...
        <div className="flex justify-between items-start mb-2">
          <div className="flex items-center gap-2 overflow-hidden">
            ...
            >
               ...
               <div className={`absolute inset-0 bg-gray-800 rounded-md transition-opacity duration-500 ${imgLoaded ? 'opacity-0' : 'opacity-100'}`} />
               
               <img 
                src={token.image} 
                alt={token.ticker} 
                className={`w-12 h-12 rounded-md object-cover border border-gray-800 group-hover:border-gray-600 transition-opacity duration-500 ${imgLoaded ? 'opacity-100' : 'opacity-0'}`}
                loading="lazy"
